...
define('dummy/tests/helpers/torii', ['exports', 'dummy/config/environment'], function (exports, _environment) {
  'use strict';
...
define('dummy/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('components/row-edit-controls/component.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/row-edit-controls/component.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('signin/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'signin/route.js should pass ESLint\n\n');
  });

  QUnit.test('sites/index/controller.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/index/controller.js should pass ESLint\n\n');
  });

  QUnit.test('sites/index/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/index/route.js should pass ESLint\n\n');
  });

  QUnit.test('sites/new/controller.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/new/controller.js should pass ESLint\n\n');
  });

  QUnit.test('sites/new/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/new/route.js should pass ESLint\n\n');
  });

  QUnit.test('sites/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/route.js should pass ESLint\n\n');
  });

  QUnit.test('sites/site/edit/controller.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/site/edit/controller.js should pass ESLint\n\n');
  });

  QUnit.test('sites/site/edit/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/site/edit/route.js should pass ESLint\n\n');
  });

  QUnit.test('sites/site/route.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'sites/site/route.js should pass ESLint\n\n');
  });
});
define('dummy/tests/lint/templates.template.lint-test', [], function () {
  ...
  QUnit.test('dummy/application/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/application/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/components/row-edit-controls/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/components/row-edit-controls/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/index/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/index/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/signin/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/signin/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/sites/index/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/sites/index/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/sites/new/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/sites/new/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/sites/site/edit/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/sites/site/edit/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/sites/site/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/sites/site/template.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('dummy/sites/template.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'dummy/sites/template.hbs should pass TemplateLint.\n\n');
  });
...
define('dummy/tests/lint/tests.lint-test', [], function () {
  ...
  QUnit.test('unit/services/feature-service-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/feature-service-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/image-service-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/image-service-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/services/map-service-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/services/map-service-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/utils/parse-url-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/utils/parse-url-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/utils/should-add-token-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/utils/should-add-token-test.js should pass ESLint\n\n');
  });
});
...
define('dummy/tests/unit/services/feature-service-test', ['qunit', 'ember-qunit', 'ember-sinon-qunit/test-support/test'], function (_qunit, _emberQunit, _test) {
  'use strict';

  (0, _qunit.module)('Unit | Service | feature service', function (hooks) {
    ...
    (0, _test.default)('getLayerInfo takes url', function (assert) {
      let service = this.owner.lookup('service:feature-service');
      this.stub(service, 'request').callsFake(function () /*url, options */{
        return Ember.RSVP.resolve({ prop: 'value' });
      });
      return service.getLayerInfo('http://foo.com/arcgis/rest/services/wat/featureserver').then(response => {
    ...
    (0, _test.default)('getLayerInfo takes url and layerId', function (assert) {
      let service = this.owner.lookup('service:feature-service');
      this.stub(service, 'request').callsFake(function () /*url, options */{
        return Ember.RSVP.resolve({ prop: 'value' });
      });
      return service.getLayerInfo('http://foo.com/arcgis/rest/services/wat/featureserver', { layer: 3 }).then(response => {
        assert.equal(response.prop, 'value');
        let args = service.request.getCall(0).args;
        let url = args[0];
...
define('dummy/tests/unit/services/image-service-test', ['qunit', 'ember-qunit', 'ember-sinon-qunit/test-support/test'], function (_qunit, _emberQunit, _test) {
  'use strict';

  (0, _qunit.module)('Unit | Service | image service', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
    ...
    (0, _test.default)('getServerInfo takes url', function (assert) {
      let service = this.owner.lookup('service:image-service');
      this.stub(service, 'request').callsFake(function () /*url, options */{
        return Ember.RSVP.resolve({ prop: 'value' });
      });
...
define('dummy/tests/unit/services/map-service-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';

  (0, _qunit.module)('Unit | Service | map service', function (hooks) {
    (0, _emberQunit.setupTest)(hooks);
...
define('dummy/tests/unit/utils/parse-url-test', ['ember-arcgis-server-services/utils/parse-url', 'qunit'], function (_parseUrl, _qunit) {
  'use strict';

  // import parseUrl from 'ember-arcgis-server-services/utils/parse-url';
  (0, _qunit.module)('Unit | Utility | parse-url', function () {
    (0, _qunit.test)('parseServerUrl', function (assert) {
      assert.equal((0, _parseUrl.parseServerUrl)('not-a-url'), 'not-a-url', 'Should return whats passed if no match');
      assert.equal((0, _parseUrl.parseServerUrl)('https://koop.dc.esri.com/something?foo=wat'), 'https://koop.dc.esri.com/something', 'Should strip querystrings if /rest not found');
      assert.equal((0, _parseUrl.parseServerUrl)('https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer/0'), 'https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer/0', 'Should return url if /rest is not found');
      assert.equal((0, _parseUrl.parseServerUrl)('https://foo.bar.com/something/arcgis/rest/services/folder/featureServer/12'), 'https://foo.bar.com/something/arcgis/rest');
      assert.equal((0, _parseUrl.parseServerUrl)('https://foo.bar.com/arcgis/rest/services/folder/featureServer/12'), 'https://foo.bar.com/arcgis/rest');
      assert.equal((0, _parseUrl.parseServerUrl)('https://foo.bar.com/someintance/rest/services/folder/featureServer/12'), 'https://foo.bar.com/someintance/rest');
    });

    (0, _qunit.test)('parseServiceUrl', function (assert) {
      assert.equal((0, _parseUrl.parseServiceUrl)('not-a-url'), 'not-a-url', 'Should return whats passed if no match');
      assert.equal((0, _parseUrl.parseServiceUrl)('https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer/0?f=json'), 'https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer');
      assert.equal((0, _parseUrl.parseServiceUrl)('https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer/0'), 'https://koop.dc.esri.com/socrata/16/sjzx-yjzi/FeatureServer');
      assert.equal((0, _parseUrl.parseServiceUrl)('https://foo.bar.com/something/arcgis/rest/services/folder/featureServer/12'), 'https://foo.bar.com/something/arcgis/rest/services/folder/featureServer');
      assert.equal((0, _parseUrl.parseServiceUrl)('https://foo.bar.com/arcgis/rest/services/folder/featureServer/12'), 'https://foo.bar.com/arcgis/rest/services/folder/featureServer');
      assert.equal((0, _parseUrl.parseServiceUrl)('https://foo.bar.com/someintance/rest/services/folder/featureServer/12'), 'https://foo.bar.com/someintance/rest/services/folder/featureServer');
    });
  });
});
define('dummy/tests/unit/utils/should-add-token-test', ['ember-arcgis-server-services/utils/should-add-token', 'qunit'], function (_shouldAddToken, _qunit) {
  'use strict';

  (0, _qunit.module)('Unit | Utility | parse-url', function () {
    (0, _qunit.test)('shouldAddToken returns false when server does not accept tokens', function (assert) {
      ...
      assert.notOk((0, _shouldAddToken.default)(url, serverInfo, portalInfo));
    });

    (0, _qunit.test)('shouldAddToken returns true when portal is owningSystemUrl', function (assert) {
      ...
      assert.ok((0, _shouldAddToken.default)(url, serverInfo, portalInfo));
    });

    (0, _qunit.test)('shouldAddToken returns false when portal is not owningSystemUrl', function (assert) {
    ...
    (0, _qunit.test)('shouldAddToken returns false when dealing across qa/dev', function (assert) {
    ...
    (0, _qunit.test)('shouldAddToken returns true when domain is an authorized Cross Origin domain', function (assert) {
    ...
    (0, _qunit.test)('shouldAddToken returns false when domain is arcgisonline', function (assert) {
